@echo off
REM
REM summary: Installation script for the OOTyW_en-US software package.
REM 
...
set _user=%USERPROFILE%\%_OpenOffice4_Userprofile%
set _ext=OOTyW-A_en-US-%_release%.oxt
...
echo -----------------------------------------------------------------
echo #
echo # Installation of OOTyW_en-US v%_release% finished.
echo #
echo -----------------------------------------------------------------
pause
