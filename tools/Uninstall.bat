@echo off
REM
REM summary: Removes the OOTyW_en-US software package.
REM 
...
REM 
REM Postconditions:
REM * Previously auto-installed items of OOTyW_en-US are removed.
...
echo -----------------------------------------------------------------
echo OOTyW_en-US (OpenOffice typography tools for yWriter users) v%_release%
...
set _ext=OOTyW_en-US-A-%_release%.oxt
...
set _ext=OOTyW_en-US-%_release%.oxt
...
set _ext=OOTyW_en-US-L-%_release%.oxt
...
echo -----------------------------------------------------------------
echo #
echo # OOTyW_en-US v%_release% is removed from your PC.
echo #
echo -----------------------------------------------------------------
pause
